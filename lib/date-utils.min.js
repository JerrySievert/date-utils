...
"undefined"===typeof a?"-":a;return this.getUTCFullYear()+a+e(this.getUTCMonth()+1,2)+a+e(this.getUTCDate(),2)});c("toDBString",function(){return this.getUTCFullYear()+"-"+e(this.getUTCMonth()+1,2)+"-"+e(this.getUTCDate(),2)+" "+e(this.getUTCHours(),2)+":"+e(this.getUTCMinutes(),2)+":"+e(this.getUTCSeconds(),2)});c("clearTime",function(){this.setHours(0);this.setMinutes(0);this.setSeconds(0);this.setMilliseconds(0);return this});c("clearUTCTime",function(){this.setUTCHours(0);this.setUTCMinutes(0);
this.setUTCSeconds(0);this.setUTCMilliseconds(0);return this});c("add",function(a){void 0!==a.milliseconds&&this.setMilliseconds(this.getMilliseconds()+a.milliseconds);void 0!==a.seconds&&this.setSeconds(this.getSeconds()+a.seconds);void 0!==a.minutes&&this.setMinutes(this.getMinutes()+a.minutes);void 0!==a.hours&&this.setHours(this.getHours()+a.hours);void 0!==a.days&&this.setDate(this.getDate()+a.days);void 0!==a.months&&this.setMonth(this.getMonth()+a.months);void 0!==a.years&&this.setFullYear(this.getFullYear()+
a.years);return this});c("addMilliseconds",function(a){return this.add({milliseconds:a})});c("addSeconds",function(a){return this.add({seconds:a})});c("addMinutes",function(a){return this.add({minutes:a})});c("addHours",function(a){return this.add({hours:a})});c("addDays",function(a){return this.add({days:a})});c("addWeeks",function(a){return this.add({days:7*a})});c("addMonths",function(a){return this.add({months:a})});c("addYears",function(a){return this.add({years:a})});c("setTimeToNow",function(){var a=
